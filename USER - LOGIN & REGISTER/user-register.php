...
<div class="form-container">
    ...
    <form action="user-register_process.php" method="POST">
        ...
        <div class="checkbox-group">
            ...
            <label>I agree to the <a href="terms-and-conditions.php" target="_blank">Terms and Conditions</a> and <a href="data-privacy-policy.php" target="_blank">
                Data Privacy Policy</a> of the website.</label>
        </div>
